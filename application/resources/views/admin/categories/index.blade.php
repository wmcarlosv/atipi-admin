...
@section('content')
    ...
    <div class="panel panel-default">
    	...
    	<div class="panel-body">
    		<a href="{{ route('categories.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> Nuevo</a>
    		<br />
    		<br />
    			...
    			<tbody>
    				@foreach($data as $d)
    					<tr>
    						...
    						<td>{{ $d->name }}</td>
    						<td>
    							<a href="{{ route('categories.edit',['id' => $d->id]) }}" class="btn btn-info"><i class="fa fa-pencil"></i> Editar</a>
