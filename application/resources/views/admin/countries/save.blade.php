...
@section('content')
    ...
    <div class="panel panel-default">
    	...
    	<div class="panel-body">
    		...
    		@else
    			{!! Form::open(['route' => ['countries.update',$data->id], 'method' => 'PUT', 'autocomplete' => 'off']) !!}
    		@endif
    			...
    			<a class="btn btn-danger" href="{{ route('countries.index') }}"><i class="fa fa-times"></i> Cancelar</a>
    		{!! Form::close() !!}
    	</div>
    </div>
@stop